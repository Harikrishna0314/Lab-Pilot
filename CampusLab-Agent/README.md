...
- Three user roles with tailored interfaces and permissions:
  1. **Student**: Book systems, view personal reservations, report equipment faults.
  2. **Faculty**: Book systems, manage project reservations.
  3. **Lab Admin**: Full management dashboard, create new labs, disable faulty equipment, mark repairs, view occupancy analytics.
...
## 🔮 Future Enhancements
1. **SSO / SAML Integration**: OAuth2 / Google Workspace login for university students.
2. **WebSocket Real-time Updates**: Real-time push updates for live seat booking matrix using Flask-SocketIO.
3. **Voice Input Assistant**: Native speech-to-text integration for accessibility.
4. **QR Code Scanning**: QR check-in at physical computer workstations.
